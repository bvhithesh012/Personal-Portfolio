  ...
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden" style={{ background: '#0A0A0A' }}>
      ...
      <div className="absolute inset-0" style={{
        backgroundImage: `
          radial-gradient(ellipse at 15% 50%, rgba(255,107,0,0.06) 0%, transparent 55%),
          radial-gradient(ellipse at 85% 20%, rgba(184,115,51,0.06) 0%, transparent 45%),
          radial-gradient(ellipse at 50% 85%, rgba(255,176,0,0.04) 0%, transparent 45%)`
      }} />
      ...
      <div className="absolute inset-0 opacity-[0.03]" style={{
        backgroundImage: `repeating-linear-gradient(
          ...
          transparent,
          transparent 40px,
          rgba(255,107,0,0.8) 40px,
          rgba(255,107,0,0.8) 41px
        )`
      }} />

      {/* Floating orbs */}
      <div className="absolute top-1/4 left-1/5 w-80 h-80 rounded-full blur-3xl" style={{
        background: 'radial-gradient(circle, rgba(255,107,0,0.07), transparent)',
        animation: 'orb1 9s ease-in-out infinite'
      }} />
      <div className="absolute bottom-1/3 right-1/4 w-64 h-64 rounded-full blur-3xl" style={{
        background: 'radial-gradient(circle, rgba(184,115,51,0.07), transparent)',
        animation: 'orb2 12s ease-in-out infinite'
      }} />
      <div className="absolute top-2/3 left-1/2 w-48 h-48 rounded-full blur-3xl" style={{
        background: 'radial-gradient(circle, rgba(255,176,0,0.05), transparent)',
  ...
  return (
    <div className="fixed inset-0 z-[-1]" style={{ background: '#0A0A0A' }}>
      ...
      >
        ...
        <pointLight position={[-10, -10, -10]} intensity={0.6} color="#B87333" />
        <Stars radius={100} depth={50} count={3000} factor={3} saturation={0} fade speed={0.6} />
        <FloatingShapes />
